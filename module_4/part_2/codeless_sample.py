...
class TestRegistrationide():
    ...
    def test_registrationide(self):
        ...
        self.driver.find_element(By.ID, "id_registration-email").send_keys("test91498164@test.ru")
        self.driver.find_element(By.ID, "id_registration-password1").click()
        self.driver.find_element(By.ID, "id_registration-password1").send_keys("ThisPasswordShouldBeFine")
        self.driver.find_element(By.ID, "id_registration-password2").click()
        self.driver.find_element(By.ID, "id_registration-password2").send_keys("ThisPasswordShouldBeFine")
